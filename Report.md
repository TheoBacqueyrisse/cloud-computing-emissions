...
Note that however, an API key for Climatiq giving access to cloud computing estimations is restricted, and we thank the Climatiq team for letting us access this feature for the time of our project.

Once having an appropriate API key, we ran the following script : 
